...
public class accusationInput extends JDialog{
	...
	public accusationInput() {
		...
		submit.addActionListener( new ActionListener() {
			  ...
			  public void actionPerformed(ActionEvent ae) {
				  ...
				  Object room = weapons.getSelectedItem();

				  
				  Solution suggestion = new Solution(((Card)person), ((Card)room), ((Card)weapon));
				  String message = board.checkAccusation(suggestion) ? "Solution is Correct" : "Solution is incorrect";
	...
	private void setUpComboBoxs() {
		...
		Border titleBorder = BorderFactory.createTitledBorder("Person Accusation");
		peopleDrop.setBorder(titleBorder);
		peopleDrop.add(people);
		
		roomsDrop = new JPanel();
		Border titleBorder1 = BorderFactory.createTitledBorder("Room Accusation");
		roomsDrop.setBorder(titleBorder1);
		roomsDrop.add(rooms);
		
		weaponsDrop = new JPanel();
		Border titleBorder2 = BorderFactory.createTitledBorder("Weapon Accusation");
